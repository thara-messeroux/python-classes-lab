...
Next, define a play_game method and confirm that the method is accessible on an instance of the Game class. 
This function will be used to activate and organize the flow of the game.
